...
class __TwigTemplate_9b91effb39e156f8981c7470d0e73ed8 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"card-body\">
        ...
        echo "\" class=\"btn btn-sm btn-outline-secondary\">Edit</a>
            ...
            <small class=\"text-muted\">
                ";
        // line 19
        echo twig_escape_filter($this->env, $this->extensions['App\Help\ReadingTimeCalculator']->getReadingTime(twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 19, $this->source); })()), "text", [], "any", false, false, false, 19)), "html", null, true);
        echo " minutes
            </small>
        </div>
    </div>
...
<div class=\"card shadow-sm\">
    ...
    <div class=\"card-body\">
        ...
        <div class=\"d-flex justify-content-between align-items-center\">
            ...
            <small class=\"text-muted\">
                {{ article.text | readingTime }} minutes
            </small>
        </div>
    </div>
</div>
