...
class __TwigTemplate_371f268f29b503c09b0f033201e1c9ac extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_main($context, array $blocks = [])
    {
        ...
        echo "</h1>
                    <p class=\"text-muted\">";
        // line 9
        echo twig_escape_filter($this->env, $this->extensions['App\Help\ReadingTimeCalculator']->getReadingTime(twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 9, $this->source); })()), "text", [], "any", false, false, false, 9)), "html", null, true);
        echo " minutes</p>
                </div>
        ...
        <div class=\"py-5 bg-light\">
            <div class=\"container\">
                <div class=\"py-5 text-center\">
                    ...
                    <p class=\"text-muted\">{{ article.text | readingTime }} minutes</p>
                </div>
